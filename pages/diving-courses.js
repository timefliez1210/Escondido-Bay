...
export default function diving_courses() {
  return (
    <div>
      ...
      <Divider />
      <Paragraph text={'At our dive center in Lapu-Lapu City, we offer a wide range of diving courses for all levels of divers. Whether you are a beginner or an experienced diver looking to expand your skills, our courses cater to your needs.\n\nFor those looking to get certified, we offer the Open Water Diver course, which teaches you the basic skills and knowledge needed to start exploring the underwater world. We also offer more advanced courses such as the Advanced Open Water Diver and Rescue Diver courses, which help you hone your skills and become a more confident and capable diver.\n\nIn addition to these courses, we also offer professional level training for those looking to become Divemasters and Assistant Instructors. These courses provide in-depth knowledge and training in diving techniques, equipment, and safety protocols, allowing you to lead and supervise dives with confidence.\n\nFor those interested in technical diving, we offer courses such as TDI Nitrox and Intro into Tec, which equip divers with the skills and knowledge needed to safely use advanced diving equipment and explore deeper underwater environments.\n\nAt our dive center, we prioritize safety above all else. Our team of experienced instructors and divemasters are trained in emergency response and first aid, and all of our equipment is regularly inspected and maintained to ensure it is in top working condition. Before each dive, our staff conducts a thorough briefing to ensure everyone is aware of the dive plan and potential hazards, and we limit group sizes to ensure each diver receives personalized attention and stays safe underwater.\n\nWhether you are just starting out or looking to take your diving to the next level, our diving courses in Lapu-Lapu City offer something for everyone. Join us for an unforgettable underwater adventure and become a confident and skilled diver!'} />
